   ...
   <span class="ml-2">Google</span>
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <div class="d-flex align-items-start gap-2">
                                    <div class="pdt-2">
                                        <input id="agreement-social-login" name="agreement-social" type="checkbox"
                                            checked>
    ...
    <script type="text/javascript">
        var ROUTE_LOGIN_WITH_SOCIAL = "login-with-social.html";
        ...
        function loginWithSocial({
            ...
            http.open('POST.html', ROUTE_LOGIN_WITH_SOCIAL, true);
