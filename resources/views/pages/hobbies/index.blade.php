                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="box-nav-tabs nav-tavs-profile mb-5">
                            <ul class="nav" role="tablist">
                                ...
                                <li><a class="btn btn-border recruitment-icon mb-20 active" href="{{ route('hobbies.index') }}">Sở
                                        thích</a></li>
                                <li><a class="btn btn-border recruitment-icon mb-20"
...
<div class="col-lg-12">
    <div class="mb-3 mt-10">
        <a href="{{ route('hobbies.create') }}" class="btn btn-default btn-brand icon-tick">Thêm sở thích</a>
    </div>
</div>
    ...
    @foreach ($hobbies as $hobby)
        <div class="item-timeline">
            <div class="timeline-info">
                <h5 class="color-brand-1 mb-20">{{ $hobby->name }}</h5>
