                                ...
                                <form method="POST" action="{{ route('projects.update', $project->id) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="start_date" type="date" name="start_date"
                                            value="{{  \Carbon\Carbon::parse($project->start_date)->format('Y-m-d') }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="end_date">Ngày kết thúc</label>
                                        <input class="form-control" id="end_date" type="date" name="end_date"
                                            value="{{  \Carbon\Carbon::parse($project->end_date) ?  \Carbon\Carbon::parse($project->end_date)->format('Y-m-d') : '' }}">
                                    </div>
