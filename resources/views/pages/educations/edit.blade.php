                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                        <div class="content-single ">
                            ...
                            <form method="POST" action="{{ route('education.update', $education) }}">
                                ...
                                @method('PUT')
                                <div class="mb-3">
                                    <label class="form-label" for="institution">Tên trường *</label>
                                    <input class="form-control" id="institution" type="text" name="institution"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="start_date" type="date" name="start_date"
                                        value="{{ \Carbon\Carbon::parse($education->start_date)->format('Y-m-d') }}"
                                        required>
                                </div>
