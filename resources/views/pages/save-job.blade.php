 ...
 @section('content')
                                 ...
                                 <div class="job-list-default job-list-saved">
                                     @foreach ($savedJobs as $savedJob)
                                         <div class="job-item-default bg-highlight job-ta"
                                             ...
                                             <div class="avatar">
                                                 <a target="_blank"
                                                     href="{{ $savedJob->jobPosting->application_email_url }}">
                                                 ...
                                                 <div class="info">
                                                     <div class="label-content">
                                                         <label class="address" data-toggle="tooltip" data-html="true"
                                                             title="{{ $savedJob->jobPosting->location }}"
                                                             data-placement="top"
                                 ...
                                 <div class="modal-dialog" role="document">
                                     <div class="modal-content">
                                         <div class="modal-header">
                                             <h5 class="modal-title" id="applyModalLabel">Chọn CV của bạn và viết thư ứng
                                                 tuyển
                                             </h5>
                                         ...
                                         <div class="modal-body">
                                             @auth('candidate')
                                                 <form id="applyForm" action="{{ route('applications.store') }}"
                                                     method="POST">
                                                     @csrf
                                                     <input type="hidden" name="job_posting_id"
                                                         value="{{ $savedJob->jobPosting->id }}">
     ...
     <script>
         document.addEventListener('DOMContentLoaded', function() {
             document.querySelectorAll('.btn-apply-now').forEach(function(button) {
