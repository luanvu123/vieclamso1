         ...
         <div class="form-group mt-3">
             <div class="d-flex align-items-start gap-2">
                 ...
                 <p class="agree-term mb-3">
                     <label for="agreement">
                         Tôi đã đọc và đồng ý với <a target="_blank" href="terms-of-service.html" class="text-success">Điều
                             khoản dịch vụ</a> và <a target="_blank" href="dieu-khoan-bao-mat.html"
