                                ...
                                <form method="POST" action="{{ route('prizes.update', $prize->id) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="organization" type="text" name="organization"
                                            value="{{ $prize->organization }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="date_awarded">Ngày trao thưởng *</label>
                                        <input class="form-control" id="date_awarded" type="date" name="date_awarded"
                                            value="{{ \Carbon\Carbon::parse($prize->date_awarded)->format('Y-m-d') }}"
                                            required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="description">Mô tả</label>
                                        <textarea class="form-control" id="description" name="description" rows="4">{{ $prize->description }}</textarea>
                                    </div>
