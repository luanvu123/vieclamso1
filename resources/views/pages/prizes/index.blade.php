                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3 mt-10">
                                        <a href="{{ route('prizes.create') }}"
                                            class="btn btn-default btn-brand icon-tick">Thêm giải thưởng</a>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($prizes as $prize)
                                        <div class="item-timeline">
                                            <div class="timeline-info">
                                                <h5 class="color-brand-1 mb-20">{{ $prize->title }}</h5>
                                                <p>{{ $prize->organization }}</p>
                                                <p>{{ \Carbon\Carbon::parse($prize->date_awarded)->format('d/m/Y') }}</p>
