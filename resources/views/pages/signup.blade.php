                    ...
                    <div class="auth-form">
                        ...
                        <form action="{{ route('employer.register') }}" method="post" id="form-register">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        placeholder="Nhập email" aria-label="Nhập email" value="{{ old('email') }}">
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i
                                                class="fa-solid fa-shield-keyhole"></i></span>
                                    </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-prepend">
                                        <button type="button" tabindex="-1"
                                            data-input-target="#password_confirmation"
                                            class="input-group-text toggle-password"></button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <button type="submit"
                                    class="btn btn-sign input-block-level w-100 h-40 btn-primary-hover g-recaptcha">Đăng
                                    ký</button>
                        ...
                        <div class="mt-3 d-flex justify-content-center option-auth text-center wrap-redirect-login">
                            <span>Bạn đã có tài khoản?<a class="text-success" href="login.html">
                                    Đăng nhập ngay
                                </a></span>
                        </div>
