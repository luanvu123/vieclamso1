...
@section('content')
                    ...
                    <div class="col">
                        ...
                        <form class="search-form" action="{{ route('search-jobs') }}" method="GET">
                            <div class="form-group">
                                <input type="text" id="key" name="keyword" value="" placeholder="Nhập từ khóa tìm kiếm...">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="box-filter">
                        <form method="GET" action="{{ route('job.filter') }}">
                            <div class="input">
                                ...
                                <input type="text" name="salary" placeholder="Mức lương" value="{{ request('salary') }}">
                                                            ...
                                                            <div class="col-title cvo-flex-grow">
                                                                <h3>
                                                                    <a href="{{ route('job.show', $jobPosting->slug) }}"
                                                                        ...
                                                                        @endif
                                                                        @if ($jobPosting->service_type === 'Tin đặc biệt' )
                                                                ...
                                                                <div class="box-footer">
                                                                    ...
                                                                    <div class="col-like">
                                                                        <a href="" onclick="saveJob({{ $jobPosting->id }})">
    ...
    <div id="top-category-carousel" class="top-category__carousel owl-carousel owl-theme">
        @foreach ($category_slider as $chunk)
            <div class="item">
                <div class="row mx-2">
                        ...
                        <div class="col-md-3">
                            <div class="top-category--item">
                                <div class="top-category__image">
                                    <a href="{{ route('categoriehomes.show', $category->slug) }}" target="_blank">
                                ...
                                <p class="top-category__caption">
                                    {{ $category->job_postings_count }} việc làm
                                </p>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="box-award-item-list">
                    @foreach ($awards as $award)
                        <div class="box-award-item">
                            ...
                            <div>
                                <a class="name_award" href="{{ $award->website }}" target="_blank">{{ $award->name }}</a>
                    ...
                    <div class="box-qr-download">
                        ...
                        <div class="box-imgs">
                            <div class="box-img-qr">
                                <img class="lazy" data-src="{{ asset('storage/' . $info->image_qr_code_download) }}" alt>
                            </div>
                            <div class="box-img-download-app">
                                ...
                                <a href="{{ $info->link_googleplay }}" class="box-img-download-chplay">
                                    <img class="lazy" data-src="{{ asset('storage/' . $info->image_googleplay) }} " alt>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="globe js-globe lazy" data-lazy-function="initGlobe">
                    <div class="svg-wrapper">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 984 984" width="984"
                            height="984" style="enable-background:new 0 0 984 984;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #217353;
                                }
                ...
                <div class="topcv-products-list">
                    @foreach ($ecosystems as $ecosystem)
                        <div class="topcv-product-item">
                            ...
                            <div class="topcv-product-content">{{ $ecosystem->detail }} </div><a class="topcv-product-viewmore"
                                target="_blank" href="{{ $ecosystem->website }}">Tìm
