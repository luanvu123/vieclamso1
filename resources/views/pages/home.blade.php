                     ...
                     <div class="svg-wrapper">
                         <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                             ...
                             <style type="text/css">
                                 ...
                                 </styl><g><path class="st0" d="M968.5,492c0,31.2-3.1,62.4-9.2,93c-6.1,30.6-15.2,60.6-27.2,89.4c-23.9,57.6-59.3,110.4-103.5,154.4
     c-44.1,
                                 44.1-96.9,
                                 79.4-154.5,
                                 103.2c-28.8,
                                 ...
                                 8.9-61.2,
                                 8.9-92H966z" />
     </g></svg></div><ul class="globe-list js-list"></ul><canvas class="globe-canvas js-canvas" width="1400" height="1200"></canvas><button class="btn-play-video"><img class="lazy" data-src="https://cdn-new.topcv.vn/unsafe/https://static.topcv.vn/v4/image/welcome/icon-play.png" alt></button><p class="globe-title">Tiếp lợi thế,
                                 nối thành công</p><div class="overlay"></div></div></div></section><section id="topcv-ecosystem"><div class="container"><h2>Hệ sinh thái công nghệ nhân sự của Vieclamso1 bao gồm 4 sản phẩm chủ lực: </h2><div class="topcv-products-list">@foreach ($ecosystems as $ecosystem)<div class="topcv-product-item"><h3 class="topcv-product-title">{{ $ecosystem->name }} </h3><div class="topcv-product-content">{{ $ecosystem->detail }} </div><a class="topcv-product-viewmore" target="_blank" href="{{ $ecosystem->website }}">Tìm hiểu thêm</span><i class="fa-solid fa-arrow-right"></i></a><div class="topcv-product-cover"><img class="lazy" data-src="{{ asset('storage/' . $ecosystem->image) }}" alt="{{ $ecosystem->name }}" style="max-width: 260px"></div></div>@endforeach</div></div></section><section id="newspapers-talk-about-topcv"><div class="container"><h2>Báo chí nói về Vieclamso1</h2><div class="box-image">@foreach ($medias as $media)<div class="box-image-item"><a target="_blank" href="{{ $media->website }}"><img data-src="{{ asset('storage/' . $media->image) }}" class="img-responsive lazy" title="{{ $media->name }}" alt="{{ $media->name }}" /></a></div>@endforeach</div></div></section></div>@endsection
