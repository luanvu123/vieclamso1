                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12 col-12 mb-50">
                        <div class="content-single">
                            <div class="tab-content">
                                ...
                                <form method="POST" action="{{ route('advisers.update', $adviser->id) }}">
                                    @csrf
                                    @method('PUT')

                                    <div class="mb-3">
                                        <label class="form-label" for="name">Tên cố vấn *</label>
                                        <input class="form-control" id="name" type="text" name="name"
                                            value="{{ $adviser->name }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="position">Chức vụ *</label>
                                        <input class="form-control" id="position" type="text" name="position"
                                            value="{{ $adviser->position }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="company">Công ty *</label>
                                        <input class="form-control" id="company" type="text" name="company"
                                            value="{{ $adviser->company }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label" for="description">Mô tả</label>
                                        <textarea class="form-control" id="description" name="description" rows="4">{{ $adviser->description }}</textarea>
                                    </div>
