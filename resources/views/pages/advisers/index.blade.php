...
<div class="col-lg-12">
    <div class="mb-3 mt-10">
        <a href="{{ route('advisers.create') }}" class="btn btn-default btn-brand icon-tick">Thêm cố vấn</a>
    </div>
</div>
    ...
    @foreach ($advisers as $adviser)
        <div class="item-timeline">
            <div class="timeline-info">
                <h5 class="color-brand-1 mb-20">{{ $adviser->name }}</h5>
                <p>{{ $adviser->position }} tại {{ $adviser->company }}</p>
