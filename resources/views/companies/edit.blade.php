...
@section('content')
    ...
    <form action="{{ route('companies.update', $company->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            @if ($company->image)
                <img src="{{ asset('storage/' . $company->image) }}" alt="Company Image" width="100">
            @endif
            @error('image')
        ...
        <div>
            ...
            <input type="text" id="scale" name="scale" value="{{ old('scale', $company->scale) }}">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" id="map" name="map" value="{{ old('map', $company->map) }}">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" id="facebook" name="facebook" value="{{ old('facebook', $company->facebook) }}">
        </div>
        <div>
            <label for="twitter">Twitter:</label>
            <input type="text" id="twitter" name="twitter" value="{{ old('twitter', $company->twitter) }}">
        </div>
        <div>
            <label for="linkedin">LinkedIn:</label>
            <input type="text" id="linkedin" name="linkedin" value="{{ old('linkedin', $company->linkedin) }}">
        </div>
