        ...
        <table class="table" id="user-table">
            ...
            <tbody>
                @foreach ($typeConsultations as $typeConsultation)
                    @php
                        $isNew = $typeConsultation->created_at->diffInHours(now()) < 2;
                    @endphp
                    <tr @if ($isNew) style="font-weight: bold;" @endif>
                        ...
                        <td>
                            <a href="{{ route('type-consultations.show', $typeConsultation) }}" class="btn btn-info"><i
                                    class="fa fa-eye"></i> View</a>
                            <a href="{{ route('type-consultations.edit', $typeConsultation) }}" class="btn btn-warning"><i
