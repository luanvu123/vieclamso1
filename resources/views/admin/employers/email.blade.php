        ...
        <div class="col-md-8 compose-right widget-shadow">
            <div class="panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="com-mail" method="POST" action="{{ route('send-email-employer') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            {!! Form::email('emailEmployer', request()->query('emailEmployer'), [
                                'class' => 'form-control',
                                'placeholder' => 'To:',
                                'required' => 'required',
                                'readonly' => 'readonly',
                            ]) !!}
                            <input type="hidden" name="employer_id" value="{{ request()->query('employer_id') }}">
                        </div>
