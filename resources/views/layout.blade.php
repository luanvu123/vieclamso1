...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <style>
        ...
        .radio-choose-active input[type='radio'] {
            display: none;
        }

        .radio-choose-active label {
            font-weight: normal;
            cursor: pointer;
        }

        .radio-choose-active label:before {
            content: " ";
            display: inline-block;
            position: relative;
            top: 5px;
        ...
        .radio-choose-active input[type=radio]:checked+label:after {
            border-radius: 10px;
            width: 10px;
            height: 10px;
            position: absolute;
                    ...
                    <li class="navbar-right__item group py16">
                        ...
                        <div class="group-hover:menu navbar__item__dropdown-menu">
                            <ul class="nav navbar-menu">
                                ...
                                <li class="navbar-menu__item">
                                    <a href="{{ route('candidate.account') }}" class="text-sm">
                                ...
                                <li class="navbar-menu__item logout">
                                    ...
                                    <form action="{{ route('candidate.logout') }}" id="candidate-logout-form"
                        ...
                        <div class="box-menu-item">
                            ...
                            <div class="box-menu-child">
                                ...
                                <a target="_blank" href="#">Hướng dẫn
                                    viết CV</a>
                                <a href="{{ route('mau.cv') }}" target="_blank">Thư viện CV theo ngành
                                    nghề</a>
